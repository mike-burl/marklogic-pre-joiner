            ...
            public Reader bulkLoadDocs(SessionState session, Reader endpointState, Reader workUnit, Stream<Reader> input) {
              return BaseProxy.XmlDocumentType.toReader(
                ...
                .withParams(
                    ...
                    BaseProxy.documentParam("workUnit", true, BaseProxy.XmlDocumentType.fromReader(workUnit)),
                    BaseProxy.documentParam("input", true, BaseProxy.XmlDocumentType.fromReader(input)))
                .withMethod("POST")
